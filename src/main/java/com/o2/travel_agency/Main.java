...
import com.o2.travel_agency.airline.service.AirlineService;
...
public class Main {
    public static void main(String[] args) {
        ...
        PlaneController planeController  = new PlaneController(createPlaneUseCase,listAllAirlinesUseCase,listAllStatusUseCase);
